...
public class _04_ArrayExample {
	...
	public static void main(String[] args) {
		...
		// 1. 자바에서 랜덤 값 생성법 1: Random 클래스 사용
		// Random.nextInt(바운드): 0 ~  바운드 -1까지의 숫자중 랜덤한 값 생성
		...
		// (int)0 * 10 <= Math.random() * 10 < (int)1 * 10
		// (int)0 * 10 + 1 <= Math.random() * 10 < (int)1 * 10
		randomVal = (int)(Math.random() * 10) + 1;
	    System.out.println(randomVal);
	    System.out.println("--------------------------");
	    
		// 3. 정수 10개를 저장하는 배열을 생성하고 1~100까지의 랜덤값을 10개 저장하세요.
